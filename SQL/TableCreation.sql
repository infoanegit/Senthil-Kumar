...
create table titleauthor(
	au_id varchar(25) foreign key references authors(au_id),
	title_id varchar(50) foreign key references Titles(title_id),
	au_ord varchar(20),
	royaltyper varchar(20))
...
create table stores(
	stor_id varchar(25) primary key,
	stor_name varchar(50) ,
	stor_address varchar(200),
	city varchar(20),
	state varchar(20),
	zip  varchar(15))
...
create table sales(
	stor_id varchar(25) foreign key references stores(stor_id),
	ord_num varchar(25) ,
	ord_date date,
	qty varchar(25),
	payterms varchar(25),
